(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, (global.riotMaterial = global.riotMaterial || {}, global.riotMaterial.components = global.riotMaterial.components || {}, global.riotMaterial.components.list = factory()));
    ...
    'exports': {
      ...
      _updateCurrent(event) {
          ...
          while (
              ...
              [parent.getAttribute(__.globals.IS_DIRECTIVE)].map(i => i && i.toUpperCase())[0] !== "RM-LIST-ITEM"
          ) {
