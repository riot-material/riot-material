(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@riot-material/new-props-wrapper')) :
    typeof define === 'function' && define.amd ? define(['@riot-material/new-props-wrapper'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, (global.riotMaterial = global.riotMaterial || {}, global.riotMaterial.components = global.riotMaterial.components || {}, global.riotMaterial.components.textfieldContainer = factory(global.riotMaterial.newPropsWrapper)));
})(this, (function (newPropsWrapper) { 'use strict';
