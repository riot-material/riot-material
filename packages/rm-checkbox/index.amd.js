define(['@riot-material/ripple'], function (ripple) { 'use strict';
    ...
    var index = {
      ...
      'template': function(template, expressionTypes, bindingTypes, getComponent) {
        return template(
          '<label><input expr4="expr4" type="checkbox" tabindex="0"/><div ref="box"><div ref="border"></div><div ref="check-box"><div ref="check"><div></div><div></div></div></div></div><div expr5="expr5" style="vertical-align: top; display: inline-block;"> </div></label>',
          [{
