(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, (global.riotMaterial = global.riotMaterial || {}, global.riotMaterial.components = global.riotMaterial.components || {}, global.riotMaterial.components.checkbox = factory(global.riotMaterial.ripple)));
    ...
    var index = {
      ...
      'exports': {
        ...
        onUpdated() {
            let box = this.root.querySelector("[ref=box]");
            let boxRipple = ripple.ripple(box, {
                disabled: this.isDisabled()
            });
        },
      ...
      'template': function(template, expressionTypes, bindingTypes, getComponent) {
        return template(
          '<label><input expr44="expr44" type="checkbox" tabindex="0"/><div ref="box"><div ref="border"></div><div ref="check-box"><div ref="check"><div></div><div></div></div></div></div><div expr45="expr45" style="vertical-align: middle; display: inline-block;"> </div></label>',
          [{
