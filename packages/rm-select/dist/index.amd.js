define(['@riot-material/rm-textfield-container', '@riot-material/rm-button', '@riot-material/rm-menu', '@riot-material/ripple', '@riot-material/before-focus-listener'], function (TextfieldContainerComponent, ButtonComponent, MenuComponent, ripple, beforeFocusListener) { 'use strict';
