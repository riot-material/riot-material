define(['@riot-material/ripple'], function (ripple) { 'use strict';
    ...
    var index = {
      ...
      'template': function(template, expressionTypes, bindingTypes, getComponent) {
        return template(
          '<label><input expr4="expr4" type="radio" tabindex="0"/><div ref="circle"><div ref="border"></div><div ref="radio-circle"></div></div><div expr5="expr5" style="vertical-align: middle; display: inline-block;"> </div></label>',
          [{
