(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, (global.riotMaterial = global.riotMaterial || {}, global.riotMaterial.components = global.riotMaterial.components || {}, global.riotMaterial.components.button = factory(global.riotMaterial.ripple)));
    ...
    var index = {
      ...
      'exports': {
        onMounted() {
            ...
            let circleRipple = ripple.ripple(
                circle,
                {
                    centered: true,
                    unbounded: true,
      ...
      'template': function(template, expressionTypes, bindingTypes, getComponent) {
        return template(
          '<label><input expr8="expr8" type="radio" tabindex="0"/><div ref="circle"><div ref="border"></div><div ref="radio-circle"></div></div><div expr9="expr9" style="vertical-align: middle; display: inline-block;"> </div></label>',
          [{
