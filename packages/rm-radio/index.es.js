...
var index = {
  ...
  'template': function(template, expressionTypes, bindingTypes, getComponent) {
    return template(
      '<label><input expr2="expr2" type="radio" tabindex="0"/><div ref="circle"><div ref="border"></div><div ref="radio-circle"></div></div><div expr3="expr3" style="vertical-align: middle; display: inline-block;"> </div></label>',
      [{
