(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@riot-material/position-controller'), require('@riot-material/ripple')) :
  typeof define === 'function' && define.amd ? define(['@riot-material/position-controller', '@riot-material/ripple'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, (global.riotMaterial = global.riotMaterial || {}, global.riotMaterial.components = global.riotMaterial.components || {}, global.riotMaterial.components.tabbedPages = factory(global.riotMaterial.positionController, global.riotMaterial.ripple)));
}(this, (function (positionController, ripple) { 'use strict';
