define(['@riot-material/ripple', 'riot', '@riot-material/rm-icon', '@riot-material/before-focus-listener'], function (ripple, riot, IconComponent, beforeFocusListener) { 'use strict';
