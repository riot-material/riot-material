define(['@riot-material/ripple', 'riot', '@riot-material/rm-icon', '@riot-material/position-controller'], function (ripple, riot, IconComponent, positionController) { 'use strict';
