(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@riot-material/ripple'), require('riot'), require('@riot-material/rm-icon'), require('@riot-material/position-controller')) :
    typeof define === 'function' && define.amd ? define(['@riot-material/ripple', 'riot', '@riot-material/rm-icon', '@riot-material/position-controller'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, (global.riotMaterial = global.riotMaterial || {}, global.riotMaterial.components = global.riotMaterial.components || {}, global.riotMaterial.components.button = factory(global.riotMaterial.ripple, global.riot, global.riotMaterial.components.icon, global.riotMaterial.positionController)));
}(this, (function (ripple, riot, IconComponent, positionController) { 'use strict';
    ...
    var index = {
      ...
      'exports': {
        ...
        onMounted() {
            ...
            if (openOverlay) {
                positionController__default['default'](button, onclick = () => {
        ...
        onBeforeUnmount() {
            positionController__default['default'](this.root.querySelector("button"), null);
        },
      ...
      'template': function(template, expressionTypes, bindingTypes, getComponent) {
        return template('<button expr20="expr20"></button><button expr22="expr22"></button>', [{
          ...
          'template': template('<slot expr21="expr21"></slot>', [{
            'expressions': [{
          ...
          'template': template('<rm-icon expr23="expr23"></rm-icon>', [{
            'expressions': [{
              'type': expressionTypes.ATTRIBUTE,
              'name': 'disabled',
