(function (global, factory) {
  ...
  var index$1 = {
    ...
    'template': function(template, expressionTypes, bindingTypes, getComponent) {
      return template('<rm-textfield-container expr25="expr25"></rm-textfield-container>', [{
        ...
        'slots': [{
          'id': 'input',
          'html': '<input expr26="expr26" slot="input"/>',
          ...
          'id': 'leading',
          'html': '<slot expr27="expr27" name="leading" slot="leading"></slot>',
          ...
          'id': 'trailing',
          'html': '<span style="white-space: nowrap;" slot="trailing"><rm-button expr28="expr28" variant="icon" dense></rm-button><slot expr29="expr29" name="trailing"></slot></span>',
