    ...
    exports.default = {
        ...
        'exports': {
            ...
            _highlight: function (value) {
                ...
                Array.prototype.forEach.call(this.root.querySelector("[ref=menu]").children, function (child) {
                    if (value != null && child.getAttribute("value") === value && !_this._highlighted) {
                        child.classList.add("rm-highlighted");
                        _this._highlighted = child;
                    }
                    else {
            ...
            _onoptionpointerenter: function (event) {
                this._highlight(this.getValueFromTarget(event.target));
            },
            _onoptionpointerleave: function (event) {
                this._highlight(null);
            },
            _onoptionclick: function (event) {
                var value = this.getValueFromTarget(event.target);
                var input = this.root.querySelector("[ref=input]");
                var beforechangeEvent = new CustomEvent("beforechange", { detail: { newValue: value } });
                ...
                if (!beforechangeEvent.defaultPrevented) {
                    ...
                    if (value && this.getValue() === value) {
                        ...
                        if (this.props.filterable != null && this.props.filterable !== "false") {
                            var menu = this.root.querySelector("[ref=menu]");
                            var elem = menu.querySelector("[value=\"" + newValue + "\"]");
                            if (!elem) {
            ...
            onMounted: function () {
                ...
                Object.defineProperty(this.root, "filter", {
                    get: function () {
                        ...
                        return _this.state.filter;
                    },
                    set: function (filter) {
                        filter = filter.toString();
                        _this.update({ filter: filter });
                    }
                });
                Object.defineProperty(this.root, "label", {
                    get: function () {
                        return _this.state.filter == null ? input.value : "";
                    }
                });
                var input = this.root.querySelector("[ref=input]");
                ...
                var formElement = this.root.querySelector("[ref='form-element']");
                window.addEventListener("change", this._onchange = function (event) {
                ...
                var raw_options = this.root.querySelector("[ref=raw_options]");
                var menu = this.root.querySelector("[ref=menu]");
                Object.defineProperty(this.root, "availableOptions", {
                    get: function () {
                        var options = [];
                        menu.style.display = "block";
                        Array.prototype.forEach.call(menu.children, function (child, index) {
                            if (--index < 0) {
                                return;
                            }
                ...
                var container = this.root.querySelector("[ref=container]");
                var setValue = function (value) {
                    ...
                    if (_this.getValue() === value) {
                        _this.root.dispatchEvent(new Event("change", { bubbles: true }));
                    }
                    if (_this.props.filterable == null || _this.props.filterable === "false") {
                        return;
                    }
                    var elem = menu.querySelector("[value=\"" + _this.getValue() + "\"]");
                    var label = elem.getAttribute("label");
                    if (label == null) {
                        label = elem.innerText;
                    }
                ...
                var updatePosition = function () {
                    if (!_this.state.selecting || frameRequest != null) {
                        return;
                    }
                ...
                var open = function () {
                    ...
                    _this._highlight(_this.getValue());
                    updatePosition();
                    _this.root.dispatchEvent(new Event("menuopen"));
                };
                ...
                input.addEventListener("keydown", function (event) {
                    switch (event.keyCode) {
                        case 38: {
                            keyHandled = true;
                            if (_this.state.selecting) {
                                if (_this._highlighted) {
                                    var previous = _this._highlighted.previousElementSibling;
                                    while (previous && previous.style.display === "none") {
                                        previous = previous.previousElementSibling;
                                    }
                                    if (previous) {
                                        _this._highlight(previous.getAttribute("value"));
                                    }
                                }
                        ...
                        case 40: {
                            ...
                            if (_this.state.selecting) {
                                if (_this._highlighted) {
                                    var next = _this._highlighted.nextElementSibling;
                                    while (next && next.style.display === "none") {
                                        next = next.nextElementSibling;
                                    }
                                    if (next) {
                                        _this._highlight(next.getAttribute("value"));
                                    }
                                }
                                else if (menu.children.length > 0) {
                                    _this._highlight(_this.getValue());
                ...
                var pointerdownOnTextfield = false;
                ...
                var addedWindowListener = false;
                var pointerInContainer = false;
                    ...
                    if (!addedWindowListener) {
                        var listener_1 = function (event) {
                            if (!pointerInContainer) {
                                ...
                                window.removeEventListener("pointerdown", listener_1);
                                ...
                                var onclick_1 = function () {
                                    ...
                                    window.removeEventListener("click", onclick_1);
                                    window.removeEventListener("pointerdown", listener_1);
                                    addedWindowListener = false;
                                };
                                window.addEventListener("click", onclick_1);
                            }
                        };
                        setTimeout(function () {
                            if (!_this.root.isConnected) {
                            ...
                            window.addEventListener("pointerdown", listener_1);
                        }, 0);
                ...
                var onchange = function () {
                    ...
                    var item = menu.querySelector("[value=\"" + _this.getValue() + "\"]");
                    if (_this.getValue() !== "") {
                        container.classList.add("rm-activated");
                        if (item) {
                            _this.root.querySelector("[ref=value]").innerHTML = item.innerHTML;
                        }
                    }
                    else {
                        container.classList.remove("rm-activated");
                        _this.root.querySelector("[ref=value]").innerHTML = "";
                    }
            ...
            onUpdated: function () {
                var _this = this;
                var menu = this.root.querySelector("[ref=menu]");
                var found = this.state.value === "";
                Array.prototype.forEach.call(this.root.querySelector("[ref=raw_options]").children, function (option, index) {
                    found = found || option.value === _this.state.value;
            ...
            getLabelOf: function (value) {
                if (!value) {
                    return "";
                }
                var raw_options = this.root.querySelector("[ref=raw_options]");
                var option = raw_options.querySelector("[value=\"" + value + "\"]");
                if (option) {
                    return option.label;
                }
                return "";
        ...
        'template': function (template, expressionTypes, bindingTypes, getComponent) {
            return template('<div ref="raw_options"><slot expr21="expr21"></slot></div><select expr22="expr22" ref="form-element" tabindex="-1"><option value></option><option expr23="expr23"></option></select><div ref="outlined-margin-top"></div><div expr24="expr24" ref="container"><div ref="border"></div><div ref="input-container"><div expr25="expr25" ref="label"> </div><input expr26="expr26" ref="input" type="text"/><div ref="value"></div></div><div ref="basic-underline"></div><div ref="underline"></div><div ref="menu" class="mdc-elevation--z8"><div expr27="expr27" value label skip-filter ref="option">&amp;nbsp;</div><div expr28="expr28" ref="option"></div></div><div ref="arrow"></div></div><div style="height: 1.25em;"><div expr29="expr29" style="font-size: .75em;"> </div></div>', [{
                            ...
                            'expressions': [{
                                    ...
                                    'evaluate': function (scope) {
                                        return (scope.props.filterable != null && scope.props.filterable !== 'false') &&
                                            ...
                                            !scope.option.label.toLowerCase().startsWith(scope.state.filter == null ? scope.getLabelOf(scope.state.value).toLowerCase() : scope.state.filter.toLowerCase()) ? 'display: none;' : '';
                                    }
                                }, {
                                    'type': expressionTypes.ATTRIBUTE,
                                    'name': 'class',
