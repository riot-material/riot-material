define(['./what-input-bd56bfc1', './ripple-20ec92c7'], function (whatInput, ripple) { 'use strict';
    ...
    var CheckboxComponent = {
      ...
      'template': function(template, expressionTypes, bindingTypes, getComponent) {
        return template(
          '<label><input expr14="expr14" type="checkbox" tabindex="0"/><div ref="box"><div ref="border"></div><div ref="check-box"><div ref="check"><div></div><div></div></div></div></div><div expr15="expr15" style="vertical-align: top; display: inline-block;"> </div></label>',
          [{
