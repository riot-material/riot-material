define(['./ripple'], function (ripple) { 'use strict';
    ...
    var rmCheckbox = {
      ...
      'template': function(template, expressionTypes, bindingTypes, getComponent) {
        return template(
          '<label><input expr52="expr52" type="checkbox" tabindex="0"/><div ref="box"><div ref="border"></div><div ref="check-box"><div ref="check"><div></div><div></div></div></div></div><div expr53="expr53" style="vertical-align: middle; display: inline-block;"> </div></label>',
          [{
