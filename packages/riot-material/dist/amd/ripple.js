define(['exports', 'tslib'], function (exports, tslib) { 'use strict';
    ...
    function ripple(element, options) {
        var _a;
        options = tslib.__assign({ radius: undefined, unbounded: false, centered: false, disabled: false, highlight: false, unboundedFocus: false, color: "currentColor", focusTarget: undefined, usePointerFocus: false, stopRippling: false }, options);
        ...
        ripple = (_a = {
                ...
                set: function (options) {
                    options = this[RIPPLE_OPTIONS] = tslib.__assign(tslib.__assign({}, this[RIPPLE_OPTIONS]), options);
