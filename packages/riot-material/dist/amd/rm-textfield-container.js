define(['./style-inject.es-dcc58f81', './what-input-bd56bfc1', './ripple-20ec92c7', 'riot', './rm-icon', './rm-button-ff460ef9'], function (styleInject_es, whatInput, ripple, riot, rmIcon, rmButton) { 'use strict';
    ...
    var TextfieldContainerComponent = {
      ...
      'template': function(template, expressionTypes, bindingTypes, getComponent) {
        return template(
          '<label expr26="expr26" class="rm-textfield-container--main"><div class="rm-textfield-container--border"></div><div class="rm-textfield-container--leading"><slot expr27="expr27" name="leading"></slot></div><div expr28="expr28" class="rm-textfield-container--border-notch"> </div><div class="rm-textfield-container--container"><div class="rm-textfield-container--content"><div expr29="expr29" class="rm-textfield-container--label"> </div><div style="position: relative; user-select: auto;"><template expr30="expr30"></template><slot expr32="expr32" name="input"></slot></div></div></div><div class="rm-textfield-container--trailing"><slot expr33="expr33" name="trailing"></slot></div><div class="rm-textfield-container--basic-underline"></div><div class="rm-textfield-container--underline"></div><div class="rm-textfield-container--disabled-block"></div></label><div style="height: 1em; line-height: 1em; margin-bottom: -1em; pointer-events: none;"><div expr34="expr34" style="font-size: .75em;"> </div></div>',
          [{
            ...
            'template': template('<slot expr31="expr31"></slot>', [{
              'type': bindingTypes.SLOT,
              'attributes': [],
              'name': 'default',
