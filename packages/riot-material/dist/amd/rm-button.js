define(['./style-inject.es-dcc58f81', './tslib.es6-3a2117de', './ripple-9ef33106', 'riot', './rm-icon', './pointerController-ae6dff1d'], function (styleInject_es, tslib_es6, ripple, riot, rmIcon, pointerController) { 'use strict';
