define(['./style-inject.es-dcc58f81', './mdc.elevation-d362346e', './elevation-9283330e', './tslib.es6-3a2117de', './ripple-9ef33106', 'riot', './rm-icon', './rm-button-4ce4def9', './rm-menu', './rm-textfield-container'], function (styleInject_es, mdc_elevation, elevation, tslib_es6, ripple, riot, rmIcon, rmButton, rmMenu, rmTextfieldContainer) { 'use strict';
