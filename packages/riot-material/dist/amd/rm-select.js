define(['./rm-button', './rm-menu', './rm-textfield-container', 'riot', './pointerController'], function (ButtonComponent, MenuComponent, TextfieldContainer, riot, pointerController) { 'use strict';
    ...
    var rmSelect = {
      ...
      'template': function(template, expressionTypes, bindingTypes, getComponent) {
        return template(
          '<rm-menu expr83="expr83" prevent-focus></rm-menu><rm-textfield-container expr85="expr85"></rm-textfield-container>',
          [{
            ...
            'slots': [{
              'id': 'input',
              'html': '<span slot="input"><input expr86="expr86" class="rm-select--input"/><div expr87="expr87" class="rm-select--label"> </div></span>',
              ...
              'id': 'leading',
              'html': '<slot expr88="expr88" name="leading" slot="leading"></slot>',
              ...
              'id': 'trailing',
              'html': '<span style="white-space: nowrap;" slot="trailing"><rm-button expr89="expr89" variant="icon" class="rm-select--clear" dense></rm-button><slot expr90="expr90" name="trailing"></slot><rm-button expr91="expr91" variant="icon" tabindex="-1" dense></rm-button></span>',
