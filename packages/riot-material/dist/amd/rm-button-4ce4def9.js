define(['exports', './ripple-9ef33106', 'riot', './rm-icon'], function (exports, ripple, riot, rmIcon) { 'use strict';
    ...
    var ButtonComponent = {
      ...
      'template': function(template, expressionTypes, bindingTypes, getComponent) {
        return template('<button expr4="expr4"></button><button expr6="expr6"></button>', [{
          ...
          'template': template('<rm-icon expr7="expr7"></rm-icon>', [{
            'expressions': [{
              'type': expressionTypes.ATTRIBUTE,
              'name': 'disabled',
