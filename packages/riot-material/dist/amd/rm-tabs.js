define(['./tslib.es6-3a2117de', './ripple-9ef33106'], function (tslib_es6, ripple) { 'use strict';
    ...
    var TabsComponent = {
      ...
      'template': function(template, expressionTypes, bindingTypes, getComponent) {
        return template('<div expr29="expr29"></div>', [{
          ...
          'template': template(
            '<div style="display: table; width: 100%; text-align: center; white-space: nowrap;" ref="tabs"><div expr30="expr30" ref="tab"></div></div><div expr32="expr32" ref="indicator"></div>',
            [{
              'type': bindingTypes.EACH,
              'getKey': null,
              'condition': null,

              'template': template('<div expr31="expr31" style="display: inline-block;"> </div>', [{
                'expressions': [{
