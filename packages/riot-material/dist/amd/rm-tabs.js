define(['./what-input-bd56bfc1', './ripple-20ec92c7'], function (whatInput, ripple) { 'use strict';
    ...
    var TabsComponent = {
      ...
      'template': function(template, expressionTypes, bindingTypes, getComponent) {
        return template('<div expr52="expr52"></div>', [{
          ...
          'template': template(
            '<div style="display: table; width: 100%; text-align: center; white-space: nowrap;" ref="tabs"><div expr53="expr53" ref="tab"></div></div><div expr55="expr55" ref="indicator"></div>',
            [{
              'type': bindingTypes.EACH,
              'getKey': null,
              'condition': null,

              'template': template('<div expr54="expr54" style="display: inline-block;"> </div>', [{
                'expressions': [{
