(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./app-bar-utils"], factory);
    }
    ...
    exports.default = {
        ...
        'exports': {
            ...
            onMounted: function () {
                var _this = this;
                this._onscoll = function () {
                    var hasShadow = false;
                    if (_this._scrollTarget != null) {
                        if (_this.props.bottom != null && _this.props.bottom !== "false") {
                            if (_this._scrollTarget instanceof Window) {
                                hasShadow = _this._scrollTarget.scrollY < _this._scrollTarget.document.documentElement.scrollHeight - _this._scrollTarget.document.documentElement.clientHeight;
                            }
                            else {
                                hasShadow = _this._scrollTarget.scrollTop < _this._scrollTarget.scrollHeight - _this._scrollTarget.clientHeight;
                            }
                        }
                        else {
                            hasShadow = _this.hasPassedElevationThreshold();
                        }
                    }
                    _this.update({ hasShadow: hasShadow });
                };
                utils.onChange(this.update, this);
                var scrollTarget = null;
                if (this.props.scrollTarget) {
                    if (typeof this.props.scrollTarget === "string") {
                        scrollTarget = (this.props.scrollTarget !== "window" ?
                            document.querySelector(this.props.scrollTarget) : window) || window;
                    }
            ...
            setScrollTarget: function (element) {
            ...
            hasPassedElevationThreshold: function () {
                var elevationThreshold = 0;
                ...
                return (this._scrollTarget instanceof Window ? this._scrollTarget.scrollY : this._scrollTarget.scrollTop) > elevationThreshold;
            },
            hasPassedBackgroundThreshold: function () {
