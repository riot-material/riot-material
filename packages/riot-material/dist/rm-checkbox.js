(function (factory) {
    ...
    exports.default = {
        ...
        'exports': {
            onMounted: function () {
                var _this = this;
                var box = this.root.querySelector("[ref=box]");
                var input = this.root.querySelector("input");
                var boxRipple = ripple_1.ripple(box, {
                    centered: true,
                    unbounded: true,
                    radius: 16,
                    unboundedFocus: true,
        ...
        'template': function (template, expressionTypes, bindingTypes, getComponent) {
            return template('<label><input expr8="expr8" type="checkbox" tabindex="0"/><div ref="box"><div ref="border"></div><div ref="check-box"><div ref="check"><div></div><div></div></div></div></div><div expr9="expr9" style="vertical-align: middle; display: inline-block;"> </div></label>', [{
