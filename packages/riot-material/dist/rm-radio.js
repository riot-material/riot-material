(function (factory) {
    ...
    exports.default = {
        ...
        'exports': {
            onMounted: function () {
                var _this = this;
                var circle = this.root.querySelector("[ref=circle]");
                var input = this.root.querySelector("input");
                var circleRipple = ripple_1.ripple(circle, {
                    centered: true,
                    unbounded: true,
                    radius: 16,
                    unboundedFocus: true,
                ...
                var refreshUI = function () {
                    if (input.checked) {
                        _this.root.classList.add("rm-checked");
                    }
                    else {
                        _this.root.classList.remove("rm-checked");
                    }
                };
                var refresh = function () {
                    ...
                    var invertedMask = parent.querySelectorAll(":scope form " + selector);
                    Array.prototype.forEach.call(parent.querySelectorAll(selector), function (input) {
                        if (Array.prototype.some.call(invertedMask, function (masked) {
                            return masked === input;
                        })) {
                            return;
                        }
        ...
        'template': function (template, expressionTypes, bindingTypes, getComponent) {
            return template('<label><input expr18="expr18" type="radio" tabindex="0"/><div ref="circle"><div ref="border"></div><div ref="radio-circle"></div></div><div expr19="expr19" style="vertical-align: middle; display: inline-block;"> </div></label>', [{
