...
import 'riot';
import './rm-icon.js';
import { B as ButtonComponent } from './rm-button-6d1f8151.js';
...
var TextfieldContainerComponent = {
  ...
  'template': function(template, expressionTypes, bindingTypes, getComponent) {
    return template(
      '<label expr155="expr155" class="rm-textfield-container--main"><div class="rm-textfield-container--border"></div><div class="rm-textfield-container--leading"><slot expr156="expr156" name="leading"></slot></div><div expr157="expr157" class="rm-textfield-container--border-notch"> </div><div class="rm-textfield-container--container"><div class="rm-textfield-container--content"><div expr158="expr158" class="rm-textfield-container--label"> </div><div style="position: relative; user-select: auto;"><template expr159="expr159"></template><slot expr161="expr161" name="input"></slot></div></div></div><div class="rm-textfield-container--trailing"><slot expr162="expr162" name="trailing"></slot></div><div class="rm-textfield-container--basic-underline"></div><div class="rm-textfield-container--underline"></div><div class="rm-textfield-container--disabled-block"></div></label><div style="height: 1em; line-height: 1em; margin-bottom: -1em; pointer-events: none;"><div expr163="expr163" style="font-size: .75em;"> </div></div>',
      [{
        ...
        'template': template('<slot expr160="expr160"></slot>', [{
          'type': bindingTypes.SLOT,
          'attributes': [],
          'name': 'default',
...
export default TextfieldContainerComponent;
