...
var ButtonComponent = {
  ...
  'template': function(template, expressionTypes, bindingTypes, getComponent) {
    return template(
      '<button expr113="expr113"></button><button expr115="expr115"></button>',
      [{
        ...
        'template': template('<slot expr114="expr114"></slot>', [{
          'expressions': [{
        ...
        'template': template('<rm-icon expr116="expr116"></rm-icon>', [{
          'expressions': [{
            'type': expressionTypes.ATTRIBUTE,
            'name': 'disabled',
          ...
          'slots': [{
            'id': 'default',
            'html': '<slot expr117="expr117"></slot>',
