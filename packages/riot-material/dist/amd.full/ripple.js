define(['exports', './lib/tslib/index'], function (exports, index) { 'use strict';
    ...
    function ripple(element, options) {
        var _a;
        options = index.__assign({ radius: undefined, unbounded: false, centered: false, disabled: false, highlight: false, unboundedFocus: false, color: "currentColor", focusTarget: undefined, usePointerFocus: false, stopRippling: false }, options);
        ...
        ripple = (_a = {
                ...
                set: function (options) {
                    options = this[RIPPLE_OPTIONS] = index.__assign(index.__assign({}, this[RIPPLE_OPTIONS]), options);
