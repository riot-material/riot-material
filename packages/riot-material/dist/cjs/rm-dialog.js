...
var DialogComponent = {
  ...
  'template': function(template, expressionTypes, bindingTypes, getComponent) {
    return template(
      '<div ref="aligner"></div><div expr61="expr61" class="mdc-elevation--z24" ref="container"><div expr62="expr62" ref="title"><slot expr63="expr63" name="title"></slot></div><div expr64="expr64" ref="content"><slot expr65="expr65" name="content"></slot></div><div expr66="expr66" ref="actions"><slot expr67="expr67" name="actions"></slot></div></div>',
      [{
