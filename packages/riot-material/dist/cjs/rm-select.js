...
var rmSelect = {
  ...
  'template': function(template, expressionTypes, bindingTypes, getComponent) {
    return template(
      '<div ref="raw_options"><slot expr110="expr110"></slot></div><select expr111="expr111" ref="form-element" tabindex="-1"><option value></option><option expr112="expr112"></option></select><div ref="outlined-margin-top"></div><div expr113="expr113" ref="container"><div ref="border"></div><div ref="input-container"><div expr114="expr114" ref="label"> </div><input expr115="expr115" ref="input" type="text"/><div ref="value"></div></div><div ref="basic-underline"></div><div ref="underline"></div><div ref="menu" class="mdc-elevation--z8"><div expr116="expr116" value label skip-filter ref="option">&nbsp;</div><div expr117="expr117" ref="option"></div></div><div ref="arrow"></div></div><div style="height: 1.25em;"><div expr118="expr118" style="font-size: .75em;"> </div></div>',
      [{
