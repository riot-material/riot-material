...
var rmSelect = {
  ...
  'template': function(template, expressionTypes, bindingTypes, getComponent) {
    return template(
      '<div ref="raw_options"><slot expr105="expr105"></slot></div><select expr106="expr106" ref="form-element" tabindex="-1"><option value></option><option expr107="expr107"></option></select><div ref="outlined-margin-top"></div><div expr108="expr108" ref="container"><div ref="border"></div><div ref="input-container"><div expr109="expr109" ref="label"> </div><input expr110="expr110" ref="input" type="text"/><div ref="value"></div></div><div ref="basic-underline"></div><div ref="underline"></div><div ref="menu" class="mdc-elevation--z8"><div expr111="expr111" value label skip-filter ref="option">&nbsp;</div><div expr112="expr112" ref="option"></div></div><div ref="arrow"></div></div><div style="height: 1.25em;"><div expr113="expr113" style="font-size: .75em;"> </div></div>',
      [{
