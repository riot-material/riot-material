...
var rmButton = {
  ...
  'template': function(template, expressionTypes, bindingTypes, getComponent) {
    return template(
      '<button expr580="expr580"></button><button expr582="expr582"></button>',
      [{
        ...
        'template': template('<slot expr581="expr581"></slot>', [{
          'expressions': [{
        ...
        'template': template('<rm-icon expr583="expr583"></rm-icon>', [{
          'expressions': [{
            'type': expressionTypes.ATTRIBUTE,
            'name': 'disabled',
          ...
          'slots': [{
            'id': 'default',
            'html': '<slot expr584="expr584"></slot>',
