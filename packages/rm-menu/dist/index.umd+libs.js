  ...
  */
  ...
  var index = {
    ...
    'exports': {
          ...
          let frame = () => {
              ...
              if (this._time === 0) {
                  ...
                  if (this._toHighlight && this._time >= 1) {
                      this._currentHighlighted = dist$1.ripple(this._lastHighlighted = this._toHighlight).highlight();
      ...
      _setHighlighted(event) {
          ...
          while (parent && parent !== container) {
              if (dist$1.isRipple(parent)) {
                  rippleElement = parent;
                  break;
              }
              parent = parent.parentElement;
          }
          if (rippleElement && !dist$1.ripple(rippleElement).getOption("disabled")) {
    ...
    'template': function(template, expressionTypes, bindingTypes, getComponent) {
      return template(
        '<div expr15="expr15"><div expr16="expr16" style="overflow-y: auto;"><slot expr17="expr17"></slot></div></div>',
        [{
