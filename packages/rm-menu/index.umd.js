(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@riot-material/elevation'), require('@riot-material/ripple'), require('focus-trap')) :
    typeof define === 'function' && define.amd ? define(['@riot-material/elevation', '@riot-material/ripple', 'focus-trap'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, (global.riotMaterial = global.riotMaterial || {}, global.riotMaterial.components = global.riotMaterial.components || {}, global.riotMaterial.components.menu = factory(global.riotMaterial.elevation, global.riotMaterial.ripple, global.focusTrap)));
}(this, (function (elevation, ripple, focusTrap) { 'use strict';
    ...
    var index = {
      ...
      'template': function(template, expressionTypes, bindingTypes, getComponent) {
        return template(
          '<div expr12="expr12"><div expr13="expr13" style="overflow-y: auto;"><slot expr14="expr14"></slot></div></div>',
          [{
